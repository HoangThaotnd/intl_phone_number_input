...
///   * [PhoneInputSelectorType.MODAL]
enum PhoneInputSelectorType { DROPDOWN, BOTTOM_SHEET, DIALOG,  MODAL}
...
class InternationalPhoneNumberInput extends StatefulWidget {
  ...
  final Decoration? countryBoxDecoration;
  final EdgeInsetsGeometry? paddingCountryBox;
  ...
  InternationalPhoneNumberInput(
      ...
      this.focusNode,
      this.cursorColor,this.titleHeaderSelectorBox,
      this.autofillHints,this.countryBoxDecoration,this.paddingCountryBox,this.helperTextSearchBox,
      this.countries})
      : super(key: key);
      ...
      getParsedPhoneNumber(parsedPhoneNumberString, this.country?.alpha2Code).then((phoneNumber) {
        if (phoneNumber == null) {
          ...
          if (widget.onInputChanged != null) {
            widget.onInputChanged!(PhoneNumber(phoneNumber: phoneNumber, isoCode: this.country?.alpha2Code, dialCode: this.country?.dialCode));
          }
             ...
             Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    padding: widget.paddingCountryBox,
                    ...
                    autoFocusSearchField: widget.autoFocusSearch,
                    isScrollControlled: widget.countrySelectorScrollControlled,
                        helperTextSearchBox: widget.helperTextSearchBox,
                      titleHeaderSelectorBox: widget.titleHeaderSelectorBox,
                  )),
                  SizedBox(
